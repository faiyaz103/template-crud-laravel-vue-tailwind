          ...
          <div class="p-5 mb-5">
           ...
           <div class="grid justify-center gap-1.5 mb-7.5">
            ...
            <div class="flex -space-x-2">
             ...
             <div class="flex">
              <span class="hover:z-5 relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-2xs size-7 text-white ring-background bg-yellow-500">
               W
              </span>
             </div>
            </div>
         ...
         <div class="kt-card overflow-hidden grow justify-between">
          <div class="p-5 mb-5">
           ...
           <div class="grid justify-center gap-1.5 mb-7.5">
            ...
            <div class="flex -space-x-2">
             <div class="flex">
              <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-24.png"/>
             </div>
             <div class="flex">
