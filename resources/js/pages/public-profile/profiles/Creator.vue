     ...
     <div class="bg-center bg-cover bg-no-repeat hero-bg">
      ...
      <div class="kt-container-fixed">
       <div class="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10">
        <div class="flex items-center justify-center rounded-full border-2 border-destructive/10 bg-background size-[100px] shrink-0">
        ...
        <div class="flex flex-wrap justify-center gap-1 lg:gap-4.5 text-sm">
         <div class="flex gap-1.25 items-center">
          <i class="ki-filled ki-icon text-muted-foreground text-sm">
          </i>
       ...
       <div class="col-span-1">
        <div class="grid gap-5 lg:gap-7.5">
          ...
          <div class="kt-card-content">
           <div class="flex flex-wrap justify-center gap-2 py-1">
            <div class="flex flex-col items-center gap-1.5">
             <span class="text-mono text-2xl lg:text-2xl font-semibold">
              397
             </span>
            ...
            <span class="sm:ms-8 sm:ps-8 border-s border-s-border">
            </span>
            <div class="flex flex-col items-center gap-1.5">
             <span class="text-mono text-2x lg:text-2xl font-semibold">
              89k
             </span>
         ...
         <div class="kt-card">
          ...
          <div class="kt-card-content">
           <p class="text-sm text-foreground leading-5.5 mb-4">
           ...
           <div class="grid gap-y-3.5">
            <div class="flex items-center gap-2.5">
             <i class="ki-filled ki-abstract-41 text-base text-muted-foreground">
             </i>
             <a class="text-sm leading-none text-mono hover:text-primary" href="#">
              KeenThemes
             </a>
            </div>
            <div class="flex items-center gap-2.5">
             <i class="ki-filled ki-crown-2 text-base text-muted-foreground">
             </i>
             <a class="text-sm leading-none text-mono hover:text-primary" href="#">
              Author
             </a>
            ...
            <div class="flex items-center gap-2.5">
             <i class="ki-filled ki-briefcase text-base text-muted-foreground">
             </i>
             <a class="text-sm leading-none text-mono hover:text-primary" href="#">
              UI/UX Desiger
             </a>
            ...
            <div class="flex items-center gap-2.5">
             <i class="ki-filled ki-sms text-base text-muted-foreground">
             </i>
             <a class="text-sm leading-none text-mono hover:text-primary" href="#">
              enny@kteam.com
             </a>
            ...
            <div class="flex items-center gap-2.5">
             <i class="ki-filled ki-abstract-39 text-base text-muted-foreground">
             </i>
             <a class="text-sm leading-none text-mono hover:text-primary" href="#">
            ...
            <div class="flex items-center gap-2.5">
             <i class="ki-filled ki-youtube text-base text-muted-foreground">
             </i>
             <a class="text-sm leading-none text-mono hover:text-primary" href="#">
              keenthemes
             </a>
       ...
       <div class="col-span-2">
        <div class="flex flex-col gap-5 lg:gap-7.5">
          ...
          <div class="kt-card-content px-10 py-7.5 lg:pe-12.5">
           <div class="flex flex-wrap xl:flex-nowrap items-center justify-between gap-6 md:gap-10 p-2.5">
            <div class="flex flex-col items-start gap-3 md:max-w-[60%]">
             ...
             <p class="text-sm font-normal text-secondary-foreground leading-5.5 mb-2.5">
             ...
             <div class="grid md:grid-cols-2 gap-2">
              <div class="flex items-center gap-1.5 pe-7.5">
               <i class="ki-filled ki-check-circle text-base text-green-500">
               </i>
               <span class="text-sm text-mono text-nowrap">
                Time-Saving
               </span>
              </div>
              <div class="flex items-center gap-1.5 pe-7.5">
         ...
         <div class="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-7.5">
          <div class="kt-card shadow-md shadow-black/5 border-0">
           <img alt="" class="w-full h-auto rounded-t-xl" src="assets/media/images/600x400/1.jpg"/>
           <div class="kt-card-border kt-card-rounded-b flex flex-col gap-2 px-5 py-4.5">
            <a class="text-lg font-medium text-mono hover:text-primary" href="html/demo1/public-profile/profiles/company.html">
             Urban Dreams
            </a>
            <div class="flex items-center justify-between grow">
             <div class="flex items-center grow">
              <img alt="" class="rounded-full size-7 me-2" src="assets/media/avatars/300-6.png"/>
              <a class="text-sm text-foreground hover:text-primary mb-px" href="html/demo1/public-profile/profiles/nft.html">
               Cody Fisher
              </a>
             </div>
             <div class="flex gap-3 items-center">
              <div class="flex gap-1 items-center">
               <i class="ki-filled ki-heart text-base text-muted-foreground">
               </i>
               <span class="text-sm text-foreground py-2">
                24
               </span>
              </div>
              <div class="flex gap-1 items-center">
               <i class="ki-filled ki-messages text-base text-muted-foreground">
               </i>
               <span class="text-sm text-foreground py-2">
                5
               </span>
         ...
         <div class="kt-card">
          ...
          <div class="kt-card-content lg:pt-7 pt-5 pb-2">
           <div class="grid gap-3.5">
            <div class="flex flex-col md:flex-row md:items-center gap-5">
             <div class="flex items-center gap-5 shrink-0">
              <div class="border border-orange-200 dark:border-orange-950 rounded-lg">
               <div class="flex items-center justify-center border-b border-orange-200 bg-orange-100 dark:border-orange-950 dark:bg-orange-950/30 rounded-t-lg">
                <span class="text-sm text-orange-400 fw-medium p-2">
                 Feb
                </span>
               </div>
               <div class="flex items-center justify-center size-12">
                <span class="font-medium text-foreground text-xl tracking-tight">
                 21
                </span>
               </div>
              </div>
             ...
             <div class="flex flex-col gap-2">
              <a class="text-sm font-medium text-primary leading-[14px] hover:text-primary mb-px" href="#">
               Webinar Series
              </a>
              <a class="text-base font-medium hover:text-primary text-mono leading-4" href="#">
               Digital Marketing Mastery Series
              </a>
              <p class="text-sm text-foreground leading-[22px]">
               Join our comprehensive webinars to master
				the art of digital marketing strategies.
              </p>
             </div>
            </div>
            <div class="not-last:border-b border-b-border">
            </div>
            <div class="flex flex-col md:flex-row md:items-center gap-5">
             <div class="flex items-center gap-5 shrink-0">
              <div class="border border-orange-200 dark:border-orange-950 rounded-lg">
         ...
         <div class="kt-card">
             ...
             <div class="ps-2.5 mb-7 text-base grow">
              <div class="flex flex-col">
               <div class="text-sm text-foreground">
                ...
                <a class="text-sm font-medium kt-link" href="html/demo1/public-profile/profiles/blogger.html">
                 Top 10 Tech Trends
                </a>
               </div>
             ...
             <div class="ps-2.5 mb-7 text-base grow">
              <div class="flex flex-col">
               <div class="text-sm text-foreground">
                ...
                <a class="text-sm kt-link" href="html/demo1/public-profile/profiles/blogger.html">
                 upcoming blog post
                </a>
               </div>
               <span class="text-xs text-secondary-foreground">
               ...
               <div class="kt-card-content lg:py-4">
                ...
                <div class="flex flex-col gap-1">
                 ...
                 <div class="flex items-center justify-center gap-1">
                  <a class="text-sm font-semibold link" href="html/demo1/public-profile/profiles/company.html">
                   Axio new release
                  </a>
             ...
             <div class="ps-2.5 mb-7 text-base grow">
              <div class="flex flex-col">
               <div class="text-sm text-mono">
                ...
                <a class="text-sm font-medium kt-ink" href="html/demo1/public-profile/profiles/feeds.html">
                 10,000 followers
                </a>
            ...
            <div class="flex items-start relative">
             ...
             <div class="ps-2.5 text-base grow">
              <div class="flex flex-col">
               <div class="text-sm text-foreground">
                We recently
                <a class="text-sm font-medium kt-link" href="html/demo1/public-profile/profiles/nft.html">
                 celebrated
                </a>
          ...
          <div class="kt-card-footer justify-center">
           <a class="kt-link kt-link-underlined kt-link-dashed" href="html/demo1/public-profile/activity.html">
            All-time Activities
           </a>
          </div>
         </div>
