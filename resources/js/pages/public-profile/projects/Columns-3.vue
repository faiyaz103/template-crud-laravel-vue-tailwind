        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-7.5">
         ...
         <div class="kt-card p-7.5">
          ...
          <div class="flex -space-x-2">
           ...
           <div class="flex">
            <span class="hover:z-5 relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-2xs size-[30px] text-destructive-inverse ring-background bg-destructive">
             M
            </span>
           </div>
          </div>
         ...
         <div class="kt-card p-7.5">
          ...
          <div class="flex -space-x-2">
           ...
           <div class="flex">
            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]" src="assets/media/avatars/300-32.png"/>
           </div>
           <div class="flex">
            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]" src="assets/media/avatars/300-2.png"/>
           </div>
         ...
         <div class="kt-card p-7.5">
          ...
          <div class="flex -space-x-2">
           ...
           <div class="flex">
            <span class="hover:z-5 relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-2xs size-[30px] text-white ring-background bg-green-500">
             K
            </span>
           </div>
          </div>
