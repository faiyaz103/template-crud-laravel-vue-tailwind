     ...
     <div class="bg-center bg-cover bg-no-repeat hero-bg">
      ...
      <div class="kt-container-fixed">
       <div class="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10">
        <img class="rounded-full border-3 border-green-500 h-[100px] shrink-0" src="assets/media/avatars/300-1.png">
         ...
         <div class="flex flex-wrap justify-center gap-1 lg:gap-4.5 text-sm">
          <div class="flex gap-1.25 items-center">
           <i class="ki-filled ki-abstract text-muted-foreground text-sm">
           </i>
       ...
       <div class="grid">
        <div class="kt-scrollable-x-auto">
         <div class="kt-menu gap-3" data-kt-menu="true">
          ...
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary active">
      ...
      <div class="flex flex-col items-stretch gap-5 lg:gap-7.5">
       ...
       <div class="flex flex-wrap items-center gap-5 justify-between">
        ...
        <div class="kt-toggle-group" data-kt-tabs="true">
         <a class="kt-btn kt-btn-icon active" data-kt-tab-toggle="#teams_cards" href="#">
          <i class="ki-filled ki-category">
          </i>
         </a>
         <a class="kt-btn kt-btn-icon" data-kt-tab-toggle="#teams_list" href="#">
       ...
       <div id="teams_cards">
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-7.5">
           ...
           <div class="grid">
            ...
            <div class="flex items-center justify-between flex-wrap gap-2">
             ...
             <div class="flex -space-x-2">
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-4.png"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-1.png"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-2.png"/>
              </div>
              <div class="flex">
         ...
         <div class="kt-card">
          <div class="kt-card-content grid gap-7 py-7.5">
           <div class="grid place-items-center gap-4">
            <div class="flex justify-center items-center size-14 rounded-full ring-1 ring-input bg-accent/60">
             <i class="ki-filled ki-abstract-22 text-2xl text-muted-foreground">
             </i>
            </div>
            <div class="grid place-items-center">
             <a class="text-base font-medium text-mono hover:text-primary mb-px" href="#">
           ...
           <div class="grid">
            ...
            <div class="flex items-center justify-between flex-wrap gap-2">
             ...
             <div class="flex -space-x-2">
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-5.png"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-7.png"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-11.png"/>
              </div>
             </div>
            </div>
           </div>
         ...
         <div class="kt-card">
          <div class="kt-card-content grid gap-7 py-7.5">
           <div class="grid place-items-center gap-4">
            <div class="flex justify-center items-center size-14 rounded-full ring-1 ring-input bg-accent/60">
             <i class="ki-filled ki-abstract-39 text-2xl text-muted-foreground">
             </i>
            </div>
            <div class="grid place-items-center">
             <a class="text-base font-medium text-mono hover:text-primary mb-px" href="#">
         ...
         <div class="kt-card">
          <div class="kt-card-content grid gap-7 py-7.5">
           <div class="grid place-items-center gap-4">
            <div class="flex justify-center items-center size-14 rounded-full ring-1 ring-input bg-accent/60">
             <i class="ki-filled ki-shield-slash text-2xl text-muted-foreground">
             </i>
            </div>
            <div class="grid place-items-center">
             <a class="text-base font-medium text-mono hover:text-primary mb-px" href="#">
           ...
           <div class="grid">
            ...
            <div class="flex items-center justify-between flex-wrap gap-2">
             ...
             <div class="flex -space-x-2 lg:justify-end">
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-23.png"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-31.png"/>
              </div>
             </div>
            </div>
           </div>
         ...
         <div class="kt-card">
          <div class="kt-card-content grid gap-7 py-7.5">
           <div class="grid place-items-center gap-4">
            <div class="flex justify-center items-center size-14 rounded-full ring-1 ring-input bg-accent/60">
             <i class="ki-filled ki-chart-line-star text-2xl text-muted-foreground">
             </i>
            </div>
            <div class="grid place-items-center">
             <a class="text-base font-medium text-mono hover:text-primary mb-px" href="#">
         ...
         <div class="kt-card">
          <div class="kt-card-content grid gap-7 py-7.5">
           <div class="grid place-items-center gap-4">
            <div class="flex justify-center items-center size-14 rounded-full ring-1 ring-input bg-accent/60">
             <i class="ki-filled ki-message-programming text-2xl text-muted-foreground">
             </i>
            </div>
            <div class="grid place-items-center">
             <a class="text-base font-medium text-mono hover:text-primary mb-px" href="#">
           ...
           <div class="grid">
            ...
            <div class="flex items-center justify-between flex-wrap gap-2">
             ...
             <div class="flex -space-x-2">
              ...
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-6.png"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-7.png"/>
              </div>
         ...
         <div class="kt-card">
          <div class="kt-card-content grid gap-7 py-7.5">
           <div class="grid place-items-center gap-4">
            <div class="flex justify-center items-center size-14 rounded-full ring-1 ring-input bg-accent/60">
             <i class="ki-filled ki-nexo text-2xl text-muted-foreground">
             </i>
            </div>
            <div class="grid place-items-center">
             <a class="text-base font-medium text-mono hover:text-primary mb-px" href="#">
           ...
           <div class="grid">
            ...
            <div class="flex items-center justify-between flex-wrap gap-2">
             ...
             <div class="flex -space-x-2">
              ...
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-17.png"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-12.png"/>
              </div>
              <div class="flex">
               <span class="relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-2xs size-7 text-white ring-background bg-green-500 size-7">
                +23
               </span>
              </div>
             </div>
         ...
         <div class="kt-card">
          <div class="kt-card-content grid gap-7 py-7.5">
           <div class="grid place-items-center gap-4">
            <div class="flex justify-center items-center size-14 rounded-full ring-1 ring-input bg-accent/60">
             <i class="ki-filled ki-abstract-44 text-2xl text-muted-foreground">
             </i>
            </div>
            <div class="grid place-items-center">
             <a class="text-base font-medium text-mono hover:text-primary mb-px" href="#">
           ...
           <div class="grid">
            ...
            <div class="flex items-center justify-between flex-wrap gap-2">
             ...
             <div class="flex -space-x-2">
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-14.png"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-3.png"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-19.png"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-9.png"/>
              </div>
             </div>
            </div>
           </div>
         ...
         <div class="kt-card">
          <div class="kt-card-content grid gap-7 py-7.5">
           <div class="grid place-items-center gap-4">
            <div class="flex justify-center items-center size-14 rounded-full ring-1 ring-input bg-accent/60">
             <i class="ki-filled ki-abstract-25 text-2xl text-muted-foreground">
             </i>
            </div>
            <div class="grid place-items-center">
             <a class="text-base font-medium text-mono hover:text-primary mb-px" href="#">
           ...
           <div class="grid">
            ...
            <div class="flex items-center justify-between flex-wrap gap-2">
             ...
             <div class="flex -space-x-2">
              ...
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-7" src="assets/media/avatars/300-16.png"/>
              </div>
              <div class="flex">
               <span class="hover:z-5 relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-2xs size-7 text-white ring-background bg-violet-500">
                S
               </span>
              </div>
             </div>
        ...
        <div class="flex grow justify-center pt-5 lg:pt-7.5">
         <a class="kt-link kt-link-underlined kt-link-dashed" href="html/demo1/account/members/teams.html">
          Show more Teams
         </a>
        </div>
       </div>
